...
class T1_TestFlow5 {
  ...
  @TransitCall(globalFunctionContainer = GlobalFunctions.class, globalFunctionName = "global1")
...
class T1_TestFlow6 {
  ...
  @TransitCall(globalFunctionContainer = GlobalFunctions.class, globalFunctionName = "global2")
  static Transition transit() {
    return null;
  }
}
...
@FlowType(name = "Test", firstStep = "step2")
class T1_TestFlow7 {
  @StepFunction(globalTransitContainer = GlobalFunctions.class, globalTransit = "global1")
  static void step2() {}
}

@FlowType(name = "Test", firstStep = "step2")
class T1_TestFlow8 {
  @StepFunction(globalTransitContainer = GlobalFunctions.class, globalTransit = "global2")
  static void step2() {}
}
