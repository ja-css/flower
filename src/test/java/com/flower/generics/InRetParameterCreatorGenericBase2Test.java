...
public class InRetParameterCreatorGenericBase2Test {
  @Test
  void test_INRET_Flow_Gen1() throws ExecutionException, InterruptedException {
    Flower flower = new Flower();
    flower.registerFlow(INRET_Flow_Gen1.class);
    flower.initialize();

    FlowExec<INRET_Flow_Gen1> helloWorldExec = flower.getFlowExec(INRET_Flow_Gen1.class);
    FlowFuture<INRET_Flow_Gen1> flowFuture =
        helloWorldExec.runFlow(new INRET_Flow_Gen1<>("Hello", " world!"));

    INRET_Flow_Gen1 state = flowFuture.getFuture().get();
    assertEquals("Hello", state.hello);
    assertEquals(" world!", state.world);
  }

  @Test
  void test_INRET_Flow_Gen1_2() throws ExecutionException, InterruptedException {
    Flower flower = new Flower();
    flower.registerFlow(INRET_Flow_Gen1.class);
    flower.registerFlow(INRET_Flow_Gen1_2.class);
    flower.initialize();

    FlowExec<INRET_Flow_Gen1_2> helloWorldExec = flower.getFlowExec(INRET_Flow_Gen1_2.class);
    FlowFuture<INRET_Flow_Gen1_2> flowFuture =
        helloWorldExec.runFlow(new INRET_Flow_Gen1_2<>("Hello", " world!"));
  ...
  @Test
  void test_INRET_Flow_Gen2() throws ExecutionException, InterruptedException {
    Flower flower = new Flower();
    flower.registerFlow(INRET_Flow_Gen2.class);
    flower.initialize();

    FlowExec<INRET_Flow_Gen2> helloWorldExec = flower.getFlowExec(INRET_Flow_Gen2.class);
    FlowFuture<INRET_Flow_Gen2> flowFuture =
        helloWorldExec.runFlow(new INRET_Flow_Gen2<>(ImmutableList.of("Hello"), " world!"));

    INRET_Flow_Gen2 state = flowFuture.getFuture().get();
    assertEquals(ImmutableList.of("Hello"), state.hello);
    assertEquals(" world!", state.world);
  }

  @Test
  void test_INRET_Flow_Gen2_2() throws ExecutionException, InterruptedException {
    Flower flower = new Flower();
    flower.registerFlow(INRET_Flow_Gen2.class);
    flower.registerFlow(INRET_Flow_Gen2_2.class);
    flower.initialize();

    FlowExec<INRET_Flow_Gen2_2> helloWorldExec = flower.getFlowExec(INRET_Flow_Gen2_2.class);
    FlowFuture<INRET_Flow_Gen2_2> flowFuture =
        helloWorldExec.runFlow(new INRET_Flow_Gen2_2<>(ImmutableList.of("Hello"), " world!"));

    INRET_Flow_Gen2_2 state = flowFuture.getFuture().get();
    assertEquals(ImmutableList.of("Hello"), state.hello);
    assertEquals(" world!", state.world);
  }
  ...
  @Test
  void test_INRET_Flow_Gen_GlobalFunctionCall1() throws ExecutionException, InterruptedException {
    Flower flower = new Flower();
    flower.registerGlobalFunctions(INRET_GlobalFunctionContainer2_1.class);
    flower.registerFlow(INRET_Flow_Gen_GlobalFunctionCall1.class);
    flower.initialize();

    FlowExec<INRET_Flow_Gen_GlobalFunctionCall1> helloWorldExec =
        flower.getFlowExec(INRET_Flow_Gen_GlobalFunctionCall1.class);
    FlowFuture<INRET_Flow_Gen_GlobalFunctionCall1> flowFuture =
        helloWorldExec.runFlow(new INRET_Flow_Gen_GlobalFunctionCall1<>("Hello", " world!"));

    INRET_Flow_Gen_GlobalFunctionCall1 state = flowFuture.getFuture().get();
    assertEquals("Hello", state.hello);
    assertEquals(" world!", state.world);
  }

  @Test
  void test_INRET_Flow_Gen_GlobalFunctionCall2() throws ExecutionException, InterruptedException {
    Flower flower = new Flower();
    flower.registerGlobalFunctions(INRET_GlobalFunctionContainer2_2.class);
    flower.registerFlow(INRET_Flow_Gen_GlobalFunctionCall2.class);
    flower.initialize();

    FlowExec<INRET_Flow_Gen_GlobalFunctionCall2> helloWorldExec =
        flower.getFlowExec(INRET_Flow_Gen_GlobalFunctionCall2.class);
    FlowFuture<INRET_Flow_Gen_GlobalFunctionCall2> flowFuture =
        helloWorldExec.runFlow(
            new INRET_Flow_Gen_GlobalFunctionCall2<>(ImmutableList.of("Hello"), " world!"));

    INRET_Flow_Gen_GlobalFunctionCall2 state = flowFuture.getFuture().get();
    assertEquals(ImmutableList.of("Hello"), state.hello);
    assertEquals(" world!", state.world);
  }

  @Test
  void test_INRET_Flow_Gen_GlobalTransitionerCall1()
      throws ExecutionException, InterruptedException {
    Flower flower = new Flower();
    flower.registerGlobalFunctions(INRET_GlobalFunctionContainer2_1.class);
    flower.registerFlow(INRET_Flow_Gen_GlobalTransitionerCall1.class);
    flower.initialize();

    FlowExec<INRET_Flow_Gen_GlobalTransitionerCall1> helloWorldExec =
        flower.getFlowExec(INRET_Flow_Gen_GlobalTransitionerCall1.class);
    FlowFuture<INRET_Flow_Gen_GlobalTransitionerCall1> flowFuture =
        helloWorldExec.runFlow(new INRET_Flow_Gen_GlobalTransitionerCall1<>("Hello", " world!"));

    INRET_Flow_Gen_GlobalTransitionerCall1 state = flowFuture.getFuture().get();
    assertEquals("Hello", state.hello);
    assertEquals(" world!", state.world);
  }

  @Test
  void test_INRET_Flow_Gen_GlobalTransitionerCall2()
      throws ExecutionException, InterruptedException {
    Flower flower = new Flower();
    flower.registerGlobalFunctions(INRET_GlobalFunctionContainer2_1.class);
    flower.registerFlow(INRET_Flow_Gen_GlobalTransitionerCall1.class);
    flower.registerFlow(INRET_Flow_Gen_GlobalTransitionerCall2.class);
    flower.initialize();

    FlowExec<INRET_Flow_Gen_GlobalTransitionerCall2> helloWorldExec =
        flower.getFlowExec(INRET_Flow_Gen_GlobalTransitionerCall2.class);
    FlowFuture<INRET_Flow_Gen_GlobalTransitionerCall2> flowFuture =
        helloWorldExec.runFlow(new INRET_Flow_Gen_GlobalTransitionerCall2<>("Hello", " world!"));

    INRET_Flow_Gen_GlobalTransitionerCall2 state = flowFuture.getFuture().get();
    assertEquals("Hello", state.hello);
    assertEquals(" world!", state.world);
  }
}
...
class INRET_Flow_Gen1<C extends X, X extends String> {
  @State final C hello;
  @State final X world;

  public INRET_Flow_Gen1(C hello, X world) {
    this.hello = hello;
    this.world = world;
  }
  ...
  @TransitFunction
  static Transition TRANSIT1(@InRet String worldRet, @StepRef Transition STEP2) {
    return STEP2;
  }
  ...
  @TransitFunction
  static Transition TRANSIT2(@InRet String helloRet, @StepRef Transition STEP3) {
    return STEP3;
  }
  ...
  @TransitFunction
  static <X extends String> Transition TRANSIT3(@InRet X helloRet, @StepRef Transition STEP4) {
    return STEP4;
  }
...
class INRET_Flow_Gen1_2<C2 extends X2, X2 extends String> extends INRET_Flow_Gen1<C2, X2> {
  ...
  public INRET_Flow_Gen1_2(C2 hello, X2 world) {
    super(hello, world);
    this.hello = hello;
    this.world = world;
  }
...
@FlowType(firstStep = "STEP1", name = "BASE")
class INRET_Flow_Gen2<C extends List<X>, X extends String> {
  @State final C hello;
  @State final X world;

  public INRET_Flow_Gen2(C hello, X world) {
    this.hello = hello;
    this.world = world;
  }
...
class INRET_Flow_Gen2_2<C2 extends List<X2>, X2 extends String> extends INRET_Flow_Gen2<C2, X2> {
  ...
  public INRET_Flow_Gen2_2(C2 hello, X2 world) {
    super(hello, world);
    this.hello = hello;
    this.world = world;
  }
...
class INRET_GlobalFunctionContainer2_1 {
  @GlobalFunction
  ...
  @GlobalFunction
  static <A extends String> Transition STEP3(@InRet A helloRet, @Terminal Transition STEP4_SF) {
    return STEP4_SF;
  }
  ...
  static <B extends G, G extends String> Transition STEP4(
      @InRet B helloRet, @In G world, @Terminal Transition END) {
    return END;
  }
}

@FlowType(firstStep = "STEP1_SF", name = "BASE")
class INRET_Flow_Gen_GlobalTransitionerCall1<C extends X, X extends String> {
  @State final C hello;
  @State final X world;

  public INRET_Flow_Gen_GlobalTransitionerCall1(C hello, X world) {
    this.hello = hello;
    this.world = world;
  }
...
class INRET_Flow_Gen_GlobalTransitionerCall2<C2 extends X2, X2 extends String>
  ...
  public INRET_Flow_Gen_GlobalTransitionerCall2(C2 hello, X2 world) {
    super(hello, world);
    this.hello = hello;
    this.world = world;
  }
...
@FlowType(firstStep = "STEP1_SF", name = "BASE")
class INRET_Flow_Gen_GlobalFunctionCall1<C extends X, X extends String> {
  @State
  final C hello;
  @State final X world;

  public INRET_Flow_Gen_GlobalFunctionCall1(C hello, X world) {
    this.hello = hello;
    this.world = world;
  }
...
@GlobalFunctionContainer
class INRET_GlobalFunctionContainer2_2 {
  @GlobalFunction
  static String STEP1_SF(@In String world) {
  ...
  @GlobalFunction
  static Transition STEP1(@In String worldRet, @StepRef Transition STEP2_SF) {
    System.out.println("Global STEP 1");
    return STEP2_SF;
  }
  ...
  @GlobalFunction
  static Transition STEP2(@In List<String> helloRet, @StepRef Transition STEP3_SF) {
    System.out.println("Global STEP 2");
    return STEP3_SF;
  }
  ...
  @GlobalFunction
  static <J extends String> Transition STEP3(@In List<J> helloRet, @StepRef Transition STEP4_SF) {
    System.out.println("Global STEP 3");
    return STEP4_SF;
  }
  ...
  static <K extends List<L>, L extends String> Transition STEP4(
      @In K helloRet, @In L world, @Terminal Transition END) {
    System.out.println("Global STEP 4");
    return END;
  }
}
...
@FlowType(firstStep = "STEP1_SF", name = "BASE")
class INRET_Flow_Gen_GlobalFunctionCall2<C extends List<X>, X extends String> {
  @State final C hello;
  @State final X world;

  public INRET_Flow_Gen_GlobalFunctionCall2(C hello, X world) {
    this.hello = hello;
    this.world = world;
  }
